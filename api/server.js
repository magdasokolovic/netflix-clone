...
app.get("/api/films/popular", controller.getAllPopular);
app.get("/api/films/top_rated", controller.getAllTopRated);
app.get("/api/films/upcoming", controller.getAllUpcoming);
